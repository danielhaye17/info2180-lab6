window.onload =function() {
    ...
    allDefinButton =document.getElementsByTagName('input')[2];

    searchButton.onclick =function() {
		ajaxFunction(); 
		requestSearch();
    }
    allDefinButton.onclick =function() {
		allDefinButton.setAttribute('all','true');
		ajaxFunction(); 
		getAllDefinitions();
	}
};
...
function getAllDefinitions() {
	...
	var url = "request.php?q="+allDefinButton.getAttribute('all');
